...
SECRET_KEY = 'django-insecure-1rxl&c^x*0e@+m8!(p-&sm10&lofoa*t79d2zv68w&zno@#++g'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost','127.0.0.1','web-production-5d32.up.railway.app', '127.0.0.0']
...
#         'HOST': os.getenv('DB_HOST'),  # ✅ not the internal hostname
#         'PORT': 5432,
#     }
# }
...
JAZZMIN_SETTINGS = {
    # "site_title": "MovieX",
    "site_header": "VShop",
    "site_brand": "El mejor lugar de accesorios",
